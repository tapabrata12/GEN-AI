...
class Details(BaseModel):
    ...
    missing_skills: Annotated[list, Field(description="")]
...
class MatchResult(BaseModel):
    ...
    reasion: Annotated[Details, Field(..., description="In this field LLM have to put the extracted name, matched skills, and missing skills")]